...
public class OrderService {
    public String ecpayCheckout(CheckoutRequest checkoutResult) {
        ...
        // 確保金額為整數字串
        String totalAmount = String.valueOf(Math.round(Double.parseDouble(checkoutResult.getAmount())));
        ...
        String tradeDesc = "訂購人:%s電話：%s";
        String description = String.format(tradeDesc, checkoutResult.getOrdersName(), checkoutResult.getOrdersTel());
