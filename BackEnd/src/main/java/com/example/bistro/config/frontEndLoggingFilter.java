...
public class frontEndLoggingFilter implements Filter {
		...
		if (session != null && session.getAttribute("membersId") != null) {
			...
			if (lastAccessTime != null) {
			    ...
			    if (remainingTime <= 0) {
			        ...
			        httpResponse.sendRedirect("https://www.google.com/"); // 重定向到登入頁面
			        return;
			    }
			}
            ...
            httpResponse.sendRedirect("https://www.google.com/");  // 重定向到登录页面
        }
	}
