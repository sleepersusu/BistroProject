      ...
      <div class="row g-5 align-items-end">
        ...
        <div class="col-lg-6 col-md-7 " >
          ...
          <span class="mb-4 pt-5" style="line-height: 1.8"  >
            ...
            <br>
            酌夜語，不僅是一家餐酒館，更是一個屬於每個人的心靈避風港。
            在這裡，無論你是與三五好友共度美好時光，還是獨自一人享受寧靜時光，我們都希望你能在這裡找到那份屬於自己的夜晚。當你推開這扇門，進入這片夜色的懷抱時，所有的疲憊與壓力都能暫時放下，心靈會在這裡得到釋放與平靜。
          </span>
          <br>

          <a class="btn btn-primary py-3 px-4 mt-3" href="">Explore More</a>
        </div>
          ...
          <div class="row g-5">
            <div class="col-12 col-sm-6 col-lg-12">
              <div class="border-start ps-4" data-aos="fade-right" data-aos-duration="2000" data-aos-delay="800" >
                ...
                <h4 class="mb-3">酌</h4>
                <span>
                  代表小酌，帶著一絲微醺的意味，意味著在忙碌的日常中，給自己留下一段放慢腳步、享受當下的時間。
                </span>
              </div>
            </div>
            <div class="col-12 col-sm-6 col-lg-12" data-aos="fade-right" data-aos-duration="2000" data-aos-delay="1300">
              <div class="border-start ps-4">
                ...
                <h4 class="mb-3">夜</h4>
                <span>
                  代表著那份隱秘的力量，讓人放下外界的喧囂與矯飾，回到最真實的自己。
                </span>
              </div>
            </div>
            <div class="col-12 col-sm-6 col-lg-12">
              <div class="border-start ps-4" data-aos="fade-right" data-aos-duration="2000" data-aos-delay="1800">
                ...
                <h4 class="mb-3">語</h4>
                <span>
                  一句不經意的對話、一段微醺的輕語，往往能溫暖心底最柔軟的角落。
                </span>
              </div>
            </div>
          </div>
  ...
  <div class="container-xxl py-5 mt-5">
    <div class="container">
      <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
        <h1 class="mb-5"  style="font-family: 'Chakra Petch', cursive !important ; font-size: 3rem;" >Team Members</h1>
      </div>
        ...
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
          <div class="team-item rounded p-4">
            ...
            <div class="d-flex justify-content-center pt-1">
              <a class="btn btn-square btn-outline-primary rounded-circle mx-1" target="_blank" href="https://www.facebook.com/"><i class="bi bi-github fs-4"></i></a>
              <a class="btn btn-square btn-outline-primary rounded-circle mx-1" target="_blank" href="https://www.facebook.com/"><i class="bi bi-linkedin fs-4"></i></a>
            </div>
          </div>
        </div>
