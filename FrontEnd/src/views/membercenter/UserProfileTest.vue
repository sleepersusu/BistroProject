  ...
  <div class="container d-flex justify-content-center align-items-center">
    <div class="row g-5 w-100">
      <div class="col-md-7 col-lg-8 mx-auto">
        ...
        <!-- Profile Section -->
        <div class="card mb-3">
          <div class="card-header" @click="toggleProfile" style="cursor: pointer;">
            <div class="d-flex justify-content-between align-items-center">
              <h5 class="mb-0">會員資料</h5>
              <i :class="['fas', profileExpanded ? 'fa-chevron-up' : 'fa-chevron-down']"></i>
            </div>
          </div>
          
          <div class="card-body" v-show="profileExpanded">
              <form class="needs-validation mt-4" @submit.prevent="imageSubmit" novalidate>
              ...
              <div class="row g-3">
                <div class="col-12">
                  ...
                  <input
                    ...
                    class="form-control"
                    id="Name"
                    v-model="store.getProfile.userName"
                ...
                <div class="col-12">
                  ...
                  <input
                    ...
                    class="form-control"
                    id="email"
                    v-model="store.getProfile.userEmail"
                    :class="{ 'is-invalid': validationErrors.userEmail }"
                    required
                  />
                  <div class="invalid-feedback">
                ...
                <div class="col-12">
                  ...
                  <input
                    ...
                    class="form-control"
                    id="phone"
                    v-model="store.getProfile.userPhone"
                    :class="{ 'is-invalid': validationErrors.userPhone }"
                    maxlength="10"
                    required
                  />
                  <div class="invalid-feedback">
                  ...
                  <div id="gender" class="d-flex">
                    ...
                    <div class="form-check me-3">
                      <input
                        ...
                        type="radio"
                        id="male"
                        v-model="store.getProfile.userGender"
                        :value="1"
                        required
                      />
                  ...
                  <div id="gender" class="d-flex">
                    ...
                    <div class="form-check me-3">
                      <input
                        ...
                        type="radio"
                        id="male"
                        v-model="store.getProfile.userFavor"
                        :value="0"
                        required
                      />
                ...
                <div class="col-12">
                  ...
                  <input
                    ...
                    class="form-control"
                    id="address"
                    v-model="store.getProfile.userAddress"
                    :class="{ 'is-invalid': validationErrors.userAddress }"
                    required
                  />
                  <div class="invalid-feedback">
                ...
                <div class="col-12">
                  ...
                  <input
                    ...
                    :class="{ 'is-invalid': validationErrors.userBirthdate }"
                    required
                  />
                  <div class="invalid-feedback">
        ...
        <div class="card mb-3">
          <div class="card-header" @click="openPasswordModal" style="cursor: pointer;">
        ...
        <div class="modal-body">
          <form @submit.prevent="handlePasswordChange">
            <div class="mb-3">
              ...
              <input type="email" class="form-control" v-model="passwordChange.email" required />
            </div>
            <div class="mb-3">
              <label class="form-label">手機號碼</label>
              <input type="tel" class="form-control" v-model="passwordChange.phone" required />
            </div>
            <div class="mb-3" v-if="passwordChange.showVerification">
              <label class="form-label">驗證碼</label>
              <div class="input-group">
                <input type="text" class="form-control" v-model="passwordChange.verificationCode" />
                <button type="button" class="btn btn-outline-primary" @click="sendVerificationCode"
                  :disabled="passwordChange.countdown > 0">
                  {{ passwordChange.countdown > 0 ? `${passwordChange.countdown}秒後重新發送` : '發送驗證碼' }}
                </button>
              </div>
            </div>
...
export default {
  ...
  setup() {
    ...
    const openPasswordModal = () => {
      const modal = new Modal(passwordModal.value)
      modal.show()
    }
    const closePasswordModal = () => {
      const modal = Modal.getInstance(passwordModal.value)
      modal.hide()
    }
    const sendVerificationCode = async () => {
      // Validate email and phone
      if (!passwordChange.email || !passwordChange.phone) {
        alert('請填寫 Email 和手機號碼')
        return
      }
      try {
        // API call to send verification code
        // await store.sendVerificationCode(passwordChange.email, passwordChange.phone)
        
        passwordChange.showVerification = true
        passwordChange.countdown = 60
        
        const timer = setInterval(() => {
          passwordChange.countdown--
          if (passwordChange.countdown <= 0) {
            clearInterval(timer)
          }
        }, 1000)
      } catch (error) {
    ...
    const handlePasswordChange = async () => {
      try {
        ...
        // await store.changePassword(passwordChange.email, passwordChange.phone, passwordChange.verificationCode)
