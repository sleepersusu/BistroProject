  ...
  <loading :active="isLoading"></loading>
    ...
    <div class="card" v-if="!isLoading">
      ...
      <div class="card-body">
        ...
        <p class="card-text" style="white-space: nowrap; text-overflow:ellipsis; 
        overflow: hidden;">{{ menu.productDescribe }}</p>
        ...
        data-bs-toggle="modal" data-bs-target="#exampleModal">
          ...
          <div style="display: flex; justify-content: center; margin: 5px 0 0 0;">
            <star-rating :rating="menu.avgScore" :read-only="true" 
            :increment="0.1" :star-size="20" style="font-size: 15px;"></star-rating>
          </div>
